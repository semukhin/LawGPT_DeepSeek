...
- Python 3.9+
- Docker и Docker Compose (если используется)
- Elasticsearch 8.x
...
│   ├── additional-styles.css # Дополнительные стили
│   ├── app.js                # Логика фронтенда
│   ├── index.html            # Основной HTML файл
│   ├── markdown.js           # Обработка Markdown
│   ├── mobile-enhancements.js # Улучшения для мобильных устройств
│   ├── modal.css             # Стили для модальных окон
│   ├── offline-support.js    # Поддержка оффлайн режима
...
5. **Фронтенд**: Разработка полноценного фронтенда на основе `index.html`
...
Проект включает в себя пример фронтенда, который находится в файле `index.html`. Для его использования:

1. Откройте файл `index.html` в вашем браузере.
2. Убедитесь, что сервер API запущен и доступен по адресу `http://127.0.0.1:8000`.
3. Используйте интерфейс для взаимодействия с API.